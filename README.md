...
- These contain indices into ``data/*/*info.json``. The files themselves are split into a list of 5 dictionaries, one for each fold. Each dictionary contains a list of train and test protein indices.
